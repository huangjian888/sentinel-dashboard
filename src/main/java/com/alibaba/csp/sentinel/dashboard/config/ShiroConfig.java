...
import com.alibaba.csp.sentinel.dashboard.config.autoconfigure.ShiroConfigProperties;
import com.alibaba.csp.sentinel.dashboard.security.shiro.cache.SpringCacheManagerWrapper;
import com.alibaba.csp.sentinel.dashboard.security.shiro.credential.RetryLimitHashedCredentialsMatcher;
import com.alibaba.csp.sentinel.dashboard.security.shiro.filter.ShiroFilterFactoryBean;
import com.alibaba.csp.sentinel.dashboard.security.shiro.filter.authc.FormAuthenticationFilter;
import com.alibaba.csp.sentinel.dashboard.security.shiro.filter.jcaptcha.JCaptchaValidateFilter;
import com.alibaba.csp.sentinel.dashboard.security.shiro.filter.online.OnlineSessionFilter;
import com.alibaba.csp.sentinel.dashboard.security.shiro.realm.UserRealm;
import com.alibaba.csp.sentinel.dashboard.security.shiro.session.CacheSessionDAO;
import com.alibaba.csp.sentinel.dashboard.security.shiro.session.SessionDAO;
import com.alibaba.csp.sentinel.dashboard.security.shiro.session.SessionManager;
import com.alibaba.csp.sentinel.dashboard.security.shiro.session.mgt.OnlineSessionFactory;
